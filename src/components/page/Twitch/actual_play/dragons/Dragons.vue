<template >
  ...
  >
    <div class="2xl:w-[50%] bg-slate-800 w-full flex h-full flex-col justify-center items-center">
      ...
      <div 
        ref="scrollContainer"
        class="flex flex-row items-center m-7 w-[80%] 2xl:w-[70%] 2 justify-start bg-slate-850 no-scrollbar overflow-x-auto py-5 "
      ...
      style="
          ...
          letter-spacing: 2px;
      ">Les Episodes</h2>
      <div class=" m-8 z-20 2xl:w-[70%]  aspect-video rounded-lg border-2 border-yellow-600 overflow-hidden">
        <iframe 
          class="w-full h-full"
          src="https://www.youtube.com/embed/videoseries?list=PL2GLJ_tbUMNGvY_bUnPGBM61G7BUsI0zr" 
      ...
      <div class="flex flex row justify-center items-center p-4 mt-4 mb-[-2rem]">
        <router-link 
          ...
          class="block text-white relative rounded-lg hover:underline 2xl:text-2xl overflow-hidden my-0 ml-4"
          :style="{ 
            fontWeight: 'bold',
            cursor: 'pointer',
            margin: 0,
