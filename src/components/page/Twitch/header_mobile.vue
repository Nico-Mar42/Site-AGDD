  ...
  <nav class="w-full bg-zinc-900 shadow-lg px-4 py-2 flex flex-col h-20 items-center relative z-50">
    ...
    <button
        ...
        <template v-if="!menuOpen">
            <!-- Burger -->
            <span class="block w-8 h-1 bg-white rounded transition-all duration-300 drop-shadow-lg" style="filter: drop-shadow(0 0 8px #FF1493);"></span>
            <span class=" my-1 block w-8 h-1 bg-white rounded transition-all duration-300 drop-shadow-lg" style="filter: drop-shadow(0 0 8px #FF1493);"></span>
            <span class="block w-8 h-1 bg-white rounded transition-all duration-300 drop-shadow-lg" style="filter: drop-shadow(0 0 8px #FF1493);"></span>
        </template>
        <template v-else>
            <!-- Croix (X) -->
